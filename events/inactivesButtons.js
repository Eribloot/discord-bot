...
module.exports = {
 ...
 async execute(interaction) {
    ...
    const filter = i => i.customId === "inactives-yes" || i.customId === "inactives-no";
    ...
    //get users from db
    const users = await Users.findAll({ attributes: ["message_time", "user_id"] });const server = interaction.guild;
